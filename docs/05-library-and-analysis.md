...
- **Beat ticks** (R7.5): light vertical lines at `beatGridOffset + n × (60 / fileBpm)` in track time (analyzed first-beat offset; not editable/dragable). Same lattice as SYNC snap + soft phase assist (R2.3). The deck BPM readout may show file×rate.
