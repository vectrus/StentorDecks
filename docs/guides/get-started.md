...
Welcome to **StentorDeck** — a two-deck DJ app built for the **Hercules DJConsole RMX2**.
...
Master (**MST**) starts at **30%** so a cold start doesn’t blast the PA.  
Raise it only after you hear a healthy level on the channel faders.

A safety limiter sits after the master knob — it catches accidents; it is not meant to “make everything louder.”

## Where is Help?

The **Help** button (top bar) opens this searchable guide. Press **F1** anytime.
